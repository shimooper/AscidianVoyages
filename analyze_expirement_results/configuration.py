...
METRIC_TO_CHOOSE_BEST_MODEL_HYPER_PARAMS = ['f1', 'auprc'] if not DEBUG_MODE else ['f1']
TEST_SET_SIZE = 0.2
...
BALANCE_CLASSES_IN_TRAINING = [False, True] if not DEBUG_MODE else [False, True]
NN_MAX_EPOCHS = 100 if not DEBUG_MODE else 5
